    ...
    def taskAction() {
        ...
        try {
            ...
            scenario.each { OdiScenario object ->
                if(!scenarioFolderName || ((object.getScenarioFolder() && scenarioFolderName) ?
                                            scenarioFolderName.toLowerCase().contains(object.getScenarioFolder().name.toLowerCase()) : false)) {
